...
public class FormularioMesaAyuda extends JFrame implements ActionListener
{
	...
	public FormularioMesaAyuda(FormularioMain anterior )
	{
		// ************************************************** FORMULARIO INICIAL
		...
		// ***********************************************   ETIQUETAS
		lb_titulo = creaEtiqueta("M  E  N  U    M E S A   D E   A Y U D A", 230, 20, 350, 50);
