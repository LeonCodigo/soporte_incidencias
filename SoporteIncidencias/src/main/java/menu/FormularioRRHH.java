...
public class FormularioRRHH extends JFrame implements ActionListener
{
	...
	public FormularioRRHH(FormularioMain anterior )
	{
		// ************************************************** FORMULARIO INICIAL
		...
		// ***********************************************   BOTONES
		btn_1= this.creaBoton("Alta tecnico",200,100, 250,50);
		btn_2 = this.creaBoton("Listar tecnicos",200,170,250,50);
		btn_3 = this.creaBoton("Baja tecnico",200,240, 250,50);
		salir = this.creaBoton("VOLVER",200,320, 250,50);
		salir.setBackground( new Color(200,200,150) );
		
		// ***********************************************   ETIQUETAS
		lb_titulo = creaEtiqueta("M  E  N  U    R R H H ", 280, 20, 350, 50);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btn_1) 
		{
			...
			FormularioCargaTecnico formularioCargaTecnico = new FormularioCargaTecnico(this);
